...
class Net(nn.Module):
    def __init__(self, input_shape=(320, 320, 3)):
        ...
        self.res_block2 = ResBlock(in_channel=64, out_channel=64, mid_channel1=32, mid_channel2=32, stride=2,
                                   kernel_size=3)
    ...
    def forward(self,x):
        ...
        aspp_shortcut = self.aspp_shortcut_40_cat(torch.cat([skip_40_40,skip_80_40],1))
