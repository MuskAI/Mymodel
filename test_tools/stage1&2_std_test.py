    ...
    def read_test_data2(self):
        ...
        try:
            ...
            for index, name in enumerate(image_name):
                ...
                rgb_pred = img * torch.where(stage1_ouput > 0, one, zero)
...
class SPTest(TestDataset):
    def __init__(self,src_data_dir = None, output_dir=None):
        self.src_data_dir = '/home/liu/chenhaoran/Tamper_Data/3月最新数据/coco_sp'
...
if __name__ == '__main__':
    try:
        output_path = '/home/liu/chenhaoran/test/0310_std_unet_factor2_3'
        ...
        model_path1 = '/home/liu/chenhaoran/Mymodel/save_model/0308_stage1&2_后缀为0306的模型,两阶段联合训练/stage1_0308_stage1&2_后缀为0306的模型,两阶段联合训练_checkpoint6-two_stage-0.316201-f10.647017-precision0.960206-acc0.975470-recall0.499838.pth'
