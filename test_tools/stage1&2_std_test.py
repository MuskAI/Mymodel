...
class TestDataset:
    def __init__(self,src_data_dir=None,gt_data_dir=None,output_dir=None, device='ljy'):
        if device == 'jly':
            self.data_root = '/data-output/3月最新数据'
        ...
        self.src_data_dir = self.SP_DATA_FOR_TRAIN_SRC
...
if __name__ == '__main__':
    try:
        output_path = ['/media/liu/File/11月数据准备/1220test/sp_train_data_two_stage/1220stage_1_pred',
                       '/media/liu/File/11月数据准备/1220test/sp_train_data_two_stage/1220stage_2_pred']
