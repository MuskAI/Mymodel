...
class Analyze:
    def __init__(self):
        ...
        pred_dir
        """
        self.pred_dir = '/media/liu/File/11月数据准备/测试/casia/1120stage_1_pred'
        self.src_dir = '/media/liu/File/10月数据准备/10月12日实验数据/casia/src'
        self.gt_dir = '/media/liu/File/10月数据准备/10月12日实验数据/casia/gt'
        """
        save_dir
        """
        self.save_band_dir = '/media/liu/File/11月数据准备/测试/casia/band'
        self.save_combine_dir = '/media/liu/File/11月数据准备/测试/casia/combineImgedge1'
        self.save_excel_dir = '/media/liu/File/11月数据准备/测试/casia/casia_band_test.xlsx'
    ...
    def __find_src_and_gt(self, name):
        ...
        gt_name = pred_name.replace('output1_', '').replace('.png','_gt.png')
