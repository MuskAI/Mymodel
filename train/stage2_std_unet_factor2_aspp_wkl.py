...
def main():
    ...
    # 2 define 3 types
    trainData = TamperDataset(stage_type='stage2', using_data=using_data, train_val_test_mode='train',device='wkl')
    valData = TamperDataset(stage_type='stage2', using_data=using_data, train_val_test_mode='val',device='wkl')
    testData = TamperDataset(stage_type='stage2', using_data=using_data_test, train_val_test_mode='test',device='wkl')
    ...
    for epoch in range(args.start_epoch, args.maxepoch):
        ...
        try:
            ...
            writer.add_scalars('tr-val_avg_loss_per_epoch', {'train': train_avg['loss_avg'],
                               ...
                               global_step=epoch)
            writer.add_scalars('tr-val_avg_f1_per_epoch', {'train': train_avg['f1_avg_stage2'],
                                                                'val': val_avg['f1_avg_stage2'],
                                                                }, global_step=epoch)

            writer.add_scalars('tr-val_avg_precision_per_epoch', {'train': train_avg['precision_avg_stage2'],
                                                                       'val': val_avg['precision_avg_stage2'],
                                                                       },
                               global_step=epoch)
            writer.add_scalars('tr-val_avg_acc_per_epoch', {'train': train_avg['accuracy_avg_stage2'],
                                                                 'val': val_avg['accuracy_avg_stage2'],
                                                                 },
                               global_step=epoch)
            writer.add_scalars('tr-val_avg_recall_per_epoch', {'train': train_avg['recall_avg_stage2'],
