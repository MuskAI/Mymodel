...
# tensorboard 使用
writer = SummaryWriter('runs/' + '0129_1-29_tensorboard_TEST')
output_name_file_name = '0129_template_sp_negative_COD10K_texture_checkpoint%d-stage1-%f-f1%f-precision%f-acc%f-recall%f.pth'
email_header = 'Python'
""""""""""""""""""""""""""""""
"    ↑↑↑↑需要修改的参数↑↑↑↑     "
""""""""""""""""""""""""""""""
...
def main():
    ...
    for epoch in range(args.start_epoch, args.maxepoch):
        ...
        try:
            ...
            send_email(email_header=str(email_header), context=str(email_output))
        except:
            pass
