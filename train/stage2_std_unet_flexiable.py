...
def main():
    ...
    for epoch in range(args.start_epoch, args.maxepoch):
        train_avg = train(model1=model1, model2=model2,optimizer1=optimizer1, optimizer2=optimizer2,
                          dataParser=trainDataLoader, epoch=epoch,train_method='stage1')
...
def train(model1, model2, optimizer1,optimizer2, dataParser, epoch,train_method='stage1'):
    # 读取数据的迭代器
