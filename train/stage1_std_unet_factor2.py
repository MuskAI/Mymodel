...
parser.add_argument('--gpu', default='0', type=str,
                    help='GPU ID')
#####################resume##########################
parser.add_argument('--resume', default='/home/liu/chenhaoran/Mymodel/save_model/0308_stage1&2_后缀为0306的模型,两阶段联合训练/stage1_0308_stage1&2_后缀为0306的模型,两阶段联合训练_checkpoint7-two_stage-0.316207-f10.695720-precision0.954358-acc0.980750-recall0.557622.pth', type=str, metavar='PATH',
